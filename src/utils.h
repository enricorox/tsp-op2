...
enum formulation_t {CUTS1, CUTS2, BENDERS, MTZ, GG, GGi, HFIXING1, HFIXING2, HFIXING3, HFIXING4, HFIXING5, SFIXING1, SFIXING2, SFIXING3, SFIXING4, FLAST}; // FLAST is enum guard
...
const char *formulation_names[16];
